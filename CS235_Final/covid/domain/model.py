...
class Article:
    def __init__(
            self, date: date, title: str, first_para: str, hyperlink: str = None, image_hyperlink: str = None, id: int = None, director: str = None, actors: str = None
    ):
        self._id: int = id
    ...
    def __eq__(self, other):
        ...
        return (
                ...
                other._image_hyperlink == self._image_hyperlink and
                other._director == self._director and
                other._actors == self._actors
        )
